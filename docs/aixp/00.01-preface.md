...
The practices described here emerge from a lifetime of software development and early adoption; from an engineering discipline derived from working across variety of projects at a variety of scales in environments that practiced the entire spectrum of development practices.  It stems from experience leading production teams, and adapting development practices to the real needs of real projects and developers that don' fit into cookie-cutter versions of development methodologies designed around specific corporate structures and needs.

The practices described here were molded through roughly a year of daily work, pairing with with multiple AI systems (primarily Claude Code, which will be the primary example in this document), on real production quality projects;  mobile apps, ai integrations, plugin development across multiple applications, developer tooling, and automation systems. A truly surprising volume and variety of work to be completed so quickly.  None of these methods were invented in advance and then tested. All of it was observed in practice, named after the fact, and cross-checked against existing engineering ptactices where a prior concept already covered it better.
