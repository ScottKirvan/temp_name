...
The practices described here from roughly a year of daily work pairing with Claude Code on real production projects — mobile apps, developer tooling, automation systems. None of it was invented in advance and then tested. All of it was observed in practice, named after the fact, and cross-checked against existing engineering literature where a prior concept already covered it better.
