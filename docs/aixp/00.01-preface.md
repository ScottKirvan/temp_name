...
The practices described here were settled on after roughly a year of daily work, pairing with with multiple AI systems, primarily Claude Code on real production quality projects — mobile apps, developer tooling, automation systems. None of it was invented in advance and then tested. All of it was observed in practice, named after the fact, and cross-checked against existing engineering literature where a prior concept already covered it better.
