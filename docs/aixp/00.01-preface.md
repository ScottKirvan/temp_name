...
The practices described here emerge from a lifetime of software development and early adoption; from an engineering discipline derived from working across variety of projects at a variety of scales in environments that practiced the entire spectrum of development practices, from leading development teams, and adapting development practices to the real needs of real projects and teams that don' fit into cookie-cutter versions of development methodologies designed around specific corporate structures and needs.
