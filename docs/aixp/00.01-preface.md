...
The practices described here were molded through roughly a year of daily work, pairing with with multiple AI systems (primarily Claude Code, which will be the primary example in this document), on real production quality projects;  mobile apps, ai integrations, plugin development across multiple applications, developer tooling, and automation systems. None of it was invented in advance and then tested. All of it was observed in practice, named after the fact, and cross-checked against existing engineering literature where a prior concept already covered it better.
